...
# This replacement faa document is used for the eggnog annotation. 
bash ../script/faa_to_eggnog.sh ../inputfile/gene_id_gene_name.txt Mycobacterium_tuberculosis_H37Rv.faa    
```
